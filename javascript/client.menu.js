$(document).ready(function() {
  ...
  $('nav#main-navigation .menu-transform').on('mouseenter', function() {
    ...
    $('menuheader a span').stop().hide(100);
    $('menuheader #logo').stop().animate({'width': '90%', 'margin-left': '-45%'}, 100);
  ...
  $('nav#main-navigation .menu-transform').on('mouseleave', function() {
    ...
    $('menuheader #logo').stop().animate({'width': '70%', 'margin-left': '-35%'}, 50);
    $('nav#main-navigation').stop().animate({'width' : '230'}, 50, function() { $('menuheader a span').stop().show(100); });
  });
